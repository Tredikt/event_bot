...
from interactives.handlers.callback.speaker_gilmanova import router as gilmanova_callback_router
from interactives.handlers.callback.speaker_horoshutina import router as horoshine_callback_router
