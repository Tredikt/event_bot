...
from interactives.handlers.callback.zabegayev import router as zabegayev_router
from interactives.handlers.callback.zargaryan import router as zargaryan_router
from interactives.handlers.callback.nurkhametova import router as nurkhametova_router
